...
describe('resource convertLoyaltyPoints', () => {
  // Prism tests are disabled
  test.skip('convert: only required params', async () => {
    const responsePromise = client.convertLoyaltyPoints.convert({
      api_token: 'api_token',
  ...
  test.skip('convert: required and optional params', async () => {
    const response = await client.convertLoyaltyPoints.convert({
      api_token: 'api_token',
      customerID: 'customerID',
    });
  });
